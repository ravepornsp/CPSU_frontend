...
const TeacherDetail = () => {
  ...
  const type = params.get("type") || "สายวิชาการ";
    ...
    <>
      ...
      <div className="container my-2">
        <div className="content-wrapper">
          <div className="teacher-card mx-auto shadow rounded p-4">
            <div className="row">
              {/* LEFT */}
      ...
      {researches.length > 0 && (
        <div className="teacher-research mx-auto shadow rounded p-4 mt-4 mb-5">
          <div className="content-wrapper">
            ...
            {researchLoading ? (
              ...
              <ul className="research-list">
                {researches.map((research, index) => (
                  <li key={index}>
                    {research.authors?.join(", ")}, "{research.title},"{" "}
                    {research.journal}
